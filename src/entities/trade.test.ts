import { sqrt, Token, CurrencyAmount, TradeType, WETH9, Ether, Percent, Price } from '@thinkincoin-libs/sdk-core'
...
import { Pair, Route as V2RouteSDK } from '@thinkincoin-libs/uniswap-v2-sdk'
